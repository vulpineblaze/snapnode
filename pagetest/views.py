...
def home(request):
    """ """
    context = {}
    return render(request, 'pagetest/home.html', context)
...
def index(request):
    ...
    template = loader.get_template('pagetest/index.html')
    ...
    return render(request, 'pagetest/index.html', context)
...
def detail(request, node_id):
    ...
    return render(request, 'pagetest/detail.html', {'node': node})
...
def new_node(request):
    ...
    return render(request, 'pagetest/new_node.html', {'form': form,'action':'new_node'})
...
def new_asset(request):
    ...
    return render(request, 'pagetest/new_asset.html', {'form': form,'action':'new_asset'})
...
def new_sub_node(request, node_id):
    ...
    return render(request, 'pagetest/new_node.html', {'form': form, 'action':'../new_sub_node/'})
...
def user_login(request):
    ...
    if request.method == 'POST':
        ...
        if user:
            ...
            if user.is_active:
                ...
                response_text = "<h1><a href='/pagetest'>Your SnapNode account is not enabled. </a></h1>"
                response_text += "<BR> Please contact the SnapNode administrator."
                return HttpResponse(response_text)
        else:
            # Bad login details were provided. So we can't log the user in.
            print "Invalid login details: {0}, {1}".format(username, password)
            return HttpResponse("<a href='/pagetest'>Invalid login details supplied for "+username+".</a>")
    ...
    # This scenario would most likely be a HTTP GET.
        ...
        if request.user.is_authenticated():
            return HttpResponseRedirect('/pagetest/')
        return render_to_response('pagetest/login.html', {}, context)
